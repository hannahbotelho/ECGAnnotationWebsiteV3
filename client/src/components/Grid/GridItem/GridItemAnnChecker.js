...
import GraphAnnChecker from '../../GraphAnnChecker'
 ...
 */
export default class GridItemAdmin extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            width: 0
    ...
    render() {
        return(
            <div ref="reference" className={styles.gridItem}>
                <GraphAnnChecker inputArr={this.props.inputArr} width={this.state.width}/>
            </div>
        );
    }
}
