...
import GraphReadOnly from "../../GraphReadOnly";
 ...
 */
export default class GridItemReadOnly extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            width: 0
    ...
    render() {
        return(
            <div ref="reference" className={styles.gridItem}>
                <GraphReadOnly callBack={this.props.callBack} inputArr={this.props.inputArr} width={this.state.width}/>
            </div>
        );
    }
}
